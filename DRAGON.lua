...
if res ~= 200 then
print('\27[0;31m⩤━━━━━━𝐁𝐀𝐋𝐋𝐈𝐄━━━━━━⩥\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na⩤━━━━━━𝐁𝐀𝐋𝐋𝐈𝐄━━━━━━⩥\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m⩤━━━━━━𝐁𝐀𝐋𝐋𝐈𝐄━━━━━━⩥\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
sudo_users = {SUDO,bot_id,1360140225,1770288756,944353237,1601519796}   
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'بيلي'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝐒𝐎𝐔𝐑𝐂𝐄⁦ 𝐁𝐀𝐋𝐋𝐈𝐄")  
...
local sourcesela = database:get(bot_id..'text:ch:user')
if sourcesela then
send(msg.chat_id_, msg.id_,'['..sourcesela..']')
else
...
send(msg.chat_id_, msg.id_,'✤︎ اهلا بك عزيزي ✤︎ ✤︎\n✤︎ لايمكنك استخدام البوت ✤︎ ✤︎\n✤︎ عليك الاشتراك في القناة ✤︎ ✤︎\n✤︎ اشترك اولا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
usertext = '\n ✤︎ العضو ← ['..result.title_..'](t.me/'..(username or 'sourcesela')..')'
status  = '\n ✤︎ تم ترقيته مطور'
...
usertext = '\n ✤︎ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcesela')..')'
status  = '\n ✤︎ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✤︎ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sourcesela')..') \n ✤︎ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ✤︎ العضو : {["..data.first_name_.."](T.ME/sourcesela)}\n ✤︎ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✤︎ عذرا ← {["..data.first_name_.."](T.ME/sourcesela)}\n ✤︎ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '  فارس الغدار ',url="t.me/I_IE_S9"}},}
...
{{text = '  𖣘 ⁽SＯＵＲＣＥ₎ 𖣘', url="t.me/sourcesela"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '⩤━━━━━━𝐁𝐀𝐋𝐋𝐈𝐄━━━━━━⩥' then
local Text = [[ 
🦇من أحسن السورسات على التليجرام سورس بيلي🦇
...
if text == 'العاب بيلي' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✤︎ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sourcesela')..') \n ✤︎ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✤︎ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'sourcesela')..') \n ✤︎ تـم قفـل التاك بالكتم ')
end,nil)   
...
if Get_info then
local TextS = "\n ✤︎ اهلا بك في متجر ملفات بيلي\n ✤︎ ملفات السورس ↓\n≪◤━───━??𝗼𝗼𝗼𝗻━───━◥≫\n\n"
local TextE = "\n⩤━━━━━━𝐁𝐀𝐋𝐋𝐈𝐄━━━━━━⩥\n ✤︎ علامة تعني { ✔️ } ملف مفعل\n ✤︎ علامة تعني { ✖ } ملف معطل\n ✤︎ قناة سورس بيلي ↓\n".." ✤︎ [اضغط هنا لدخول](t.me/sourcesela) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ✤︎ عذرا الملف لايدعم سورس بيلي \n") 
end
return false
end
...
if text == ("مسح قائمه بيلي") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ✤︎ تم مسح قائمه بيلي')
return false
end

if text == 'قائمه بيلي' and Sudo(msg) then
...
if text == ("رفع بيلي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local sourcesela = database:get(bot_id..'text:ch:user')
if sourcesela then
send(msg.chat_id_, msg.id_,'['..sourcesela..']')
...
if text and text:match("^رفع بيلي @(.*)$") and Sudo(msg) then
local username = text:match("^رفع بيلي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local sourcesela = database:get(bot_id..'text:ch:user')
if sourcesela then
send(msg.chat_id_, msg.id_,'['..sourcesela..']')
...
if text and text:match("^رفع بيلي (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع بيلي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local sourcesela = database:get(bot_id..'text:ch:user')
if sourcesela then
send(msg.chat_id_, msg.id_,'['..sourcesela..']')
...
if text == ("تنزيل بيلي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local sourcesela = database:get(bot_id..'text:ch:user')
if sourcesela then
send(msg.chat_id_, msg.id_,'['..sourcesela..']')
...
if text and text:match("^تنزيل بيلي @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل بيلي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local sourcesela = database:get(bot_id..'text:ch:user')
if sourcesela then
send(msg.chat_id_, msg.id_,'['..sourcesela..']')
...
if text and text:match("^تنزيل بيلي (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل بيلي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local sourcesela = database:get(bot_id..'text:ch:user')
if sourcesela then
send(msg.chat_id_, msg.id_,'['..sourcesela..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✤︎ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcesela')..')'
status  = '\n ✤︎ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✤︎ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✤︎ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcesela')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✤︎ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'sourcesela')..')'..'\n ✤︎ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄⁦ 𝐁𝐀𝐋𝐋𝐈𝐄.',url="t.me/sourcesela"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."sourcesela:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."sourcesela:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."sourcesela:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."sourcesela:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"✤︎تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."sourcesela:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."sourcesela:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس بيلي يعني لو بكتهن راح اعرفك انت الاخذتهن
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/sourcesela)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/sourcesela)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/sourcesela)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/sourcesela)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/sourcesela)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/sourcesela)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/sourcesela)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/sourcesela)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/sourcesela)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/sourcesela)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/sourcesela)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/sourcesela)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/sourcesela)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/sourcesela)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/sourcesela)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/sourcesela)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/sourcesela)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/sourcesela)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/sourcesela)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/sourcesela)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/sourcesela)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/sourcesela)') 
return false
end
end
end
...
✯اوامر الالعاب كتالي 
⩤━━━━━━𝐁𝐀𝐋𝐋𝐈𝐄━━━━━━⩥
 ✯تفعيل الالعاب ✤︎ لتفعيل العبه ° 
 ✯تعطيل الالعاب ✤︎ لتعطيل العبه °
⩤━━━━━━𝐁𝐀𝐋𝐋𝐈𝐄━━━━━━⩥
...
{{text = 'SkodaHockey1 ', url="https://t.me/gamee?game=SkodaHockey1"},{text = 'SummerLove', url="https://t.me/gamee?game=SummerLove"}},  
{{text = 'SmartUpShark', url="https://t.me/gamee?game=SmartUpShark"},{text = 'SpikyFish3', url="https://t.me/gamee?game=SpikyFish3"}},  
{{text = '  ✤ ⁽SＯＵＲＣＥ₎ ✤', url="t.me/sourcesela"}},
{{text = 'BACK🦇 ', callback_data="/add"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
